...
public class CoolLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"POOL", "LET", "IN", "CLASS", "INHERITS", "BOOL", "NOT", "NEW", "ISVOID", 
			"STRING", "ESCAPED_NEWLINE", "LETTER", "ID", "DIGIT", "INT", "DIGITS", 
			"AT", "PERIOD", "SEMI", "COLON", "COMMA", "ASSIGN", "BRANCH", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "PLUS", "MINUS", "MULT", "DIV", "EQUAL", 
			"LT", "LE", "COMPL", "NEW_LINE", "LINE_COMMENT", "BLOCK_COMMENT", "UMATCHED_COMMENT", 
			"INVALID"
		};
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 47:
			...
			break;
		case 48:
			UMATCHED_COMMENT_action((RuleContext)_localctx, actionIndex);
			break;
		case 49:
	...
	private void UMATCHED_COMMENT_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 5:
